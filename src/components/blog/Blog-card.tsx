...
export function BlogCard({ title, date, slug }: BlogCardProps) {
  return (
    <Link href={`/blog/${slug}`} className="flex flex-col gap-3 items-center bg-neutral-800 rounded-lg p-8 border-1 border-gray-700 hover:border-sky-600 hover:bg-neutral-700 shadow-md transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl hover:z-10">
