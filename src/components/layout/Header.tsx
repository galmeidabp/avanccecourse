  ...
  return (
    <div className="flex justify-between items-center py-5 max-w-sm m-auto md:max-w-xl lg:max-w-5xl">
      ...
      <ul className="flex gap-3 text-gray-400 md:gap-8 lg:gap-10">
        ...
        <li className="hover:cursor-pointer hover:text-blue-400"><Link href="/course-listing">Cursos</Link></li>
        <li className="hover:cursor-pointer hover:text-blue-400"><Link href="/blog">Blog</Link></li>
