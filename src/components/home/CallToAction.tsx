...
export function CallToAction() {
  return (
    <div className="m-auto max-w-sm md:max-w-xl lg:max-w-4xl">
      <div data-aos="fade-down" className="flex flex-col-reverse items-center md:gap-20 md:flex-row">
        <div className="">
      ...
      <div data-aos="fade-down" className="flex flex-col-reverse items-center gap-1 mt-30 bg-neutral-800 rounded-2xl lg:flex-row lg:gap-8 lg:items-start lg:pr-15">
